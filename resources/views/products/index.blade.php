        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('products.create') }}" class="btn btn-dark btn-sm my-2">
                    ...
                    @else
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered align-middle text-nowrap" id="productTable">
                                ...
                                @foreach ($products as $index => $product)
                                    <tr>
                                        ...
                                        <td>
                                            @if($product->image)
                                                <img src="{{ asset('storage/'. $product->image) }}" alt="Product" class="img-fluid rounded" style="max-width: 80px;">
                                            @else
                                                <span>No Image</span>
                                            @endif
                                        </td>
